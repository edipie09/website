...
Suppose we want to find all instances of players hitting more than 50 homeruns. We want to display the first and last names of players, the team ID, the year ID, and the homerun totals.
